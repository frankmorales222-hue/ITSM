...
[Migration("20260729124357_AssetInventoryFoundation")]
public class AssetInventoryFoundation : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.CreateTable("Assets", delegate(ColumnsBuilder table)
		{
			OperationBuilder<AddColumnOperation> assetId = table.Column<int>("INTEGER").Annotation("Sqlite:Autoincrement", true);
			int? maxLength = 80;
			OperationBuilder<AddColumnOperation> assetTag = table.Column<string>("TEXT", null, maxLength);
			maxLength = 255;
			OperationBuilder<AddColumnOperation> hostname = table.Column<string>("TEXT", null, maxLength, rowVersion: false, null, nullable: true);
			maxLength = 160;
			OperationBuilder<AddColumnOperation> serialNumber = table.Column<string>("TEXT", null, maxLength, rowVersion: false, null, nullable: true);
			maxLength = 200;
			OperationBuilder<AddColumnOperation> name = table.Column<string>("TEXT", null, maxLength);
			maxLength = 50;
			OperationBuilder<AddColumnOperation> status = table.Column<string>("TEXT", null, maxLength);
			maxLength = 50;
			OperationBuilder<AddColumnOperation> condition = table.Column<string>("TEXT", null, maxLength);
			maxLength = 100;
			OperationBuilder<AddColumnOperation> category = table.Column<string>("TEXT", null, maxLength);
			maxLength = 100;
			OperationBuilder<AddColumnOperation> assetType = table.Column<string>("TEXT", null, maxLength);
			maxLength = 100;
			OperationBuilder<AddColumnOperation> manufacturer = table.Column<string>("TEXT", null, maxLength, rowVersion: false, null, nullable: true);
			maxLength = 150;
			OperationBuilder<AddColumnOperation> model = table.Column<string>("TEXT", null, maxLength, rowVersion: false, null, nullable: true);
			maxLength = 200;
			OperationBuilder<AddColumnOperation> assignedTo = table.Column<string>("TEXT", null, maxLength, rowVersion: false, null, nullable: true);
			maxLength = 150;
			...
			maxLength = 150;
			OperationBuilder<AddColumnOperation> vendor = table.Column<string>("TEXT", null, maxLength, rowVersion: false, null, nullable: true);
			maxLength = 150;
			return new
			{
				AssetId = assetId,
				...
				Location = location,
				Vendor = vendor,
				Purpose = table.Column<string>("TEXT", null, maxLength, rowVersion: false, null, nullable: true),
				PurchaseDate = table.Column<DateOnly>("TEXT", null, null, rowVersion: false, null, nullable: true),
				PurchaseCostCents = table.Column<long>("INTEGER", null, null, rowVersion: false, null, nullable: true),
				WarrantyExpiration = table.Column<DateOnly>("TEXT", null, null, rowVersion: false, null, nullable: true),
		...
		migrationBuilder.CreateIndex("IX_Assets_AssetTag", "Assets", "AssetTag", null, unique: true);
		migrationBuilder.CreateIndex("IX_Assets_Hostname", "Assets", "Hostname", null, unique: true);
		migrationBuilder.CreateIndex("IX_Assets_SerialNumber", "Assets", "SerialNumber", null, unique: true);
	}
