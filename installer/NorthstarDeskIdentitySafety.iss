; Asset identity safety release.
; Replaces only the packaged server executable and endpoint-agent installer.
; It does not write the database, .env, Caddyfile, HTTPS certificates, ports,
; task definitions, or any existing configuration.

#define MyAppName "Northstar Desk Asset Identity Safety Update"
#define MyAppVersion "0.4.77"
...
OutputDir=artifacts
OutputBaseFilename=NorthstarDesk-Asset-Identity-Safety-Update-{#MyAppVersion}
