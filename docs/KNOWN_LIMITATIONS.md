...
- AssetPilot-to-ITSM refresh is currently administrator-triggered. Automatic employee/account provisioning and welcome email require a scheduled synchronization policy plus an authenticated SMTP or Microsoft Graph delivery configuration.
